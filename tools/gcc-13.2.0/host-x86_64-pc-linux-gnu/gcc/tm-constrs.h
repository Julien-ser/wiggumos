...
satisfies_constraint_Bk (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (memory_operand (op, mode)) && (!(
#line 196 "../.././gcc/config/i386/constraints.md"
...
satisfies_constraint_Bs (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return ((!(
#line 208 "../.././gcc/config/i386/constraints.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && ((!(
#line 209 "../.././gcc/config/i386/constraints.md"
...
satisfies_constraint_Bw (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return ((!(
#line 217 "../.././gcc/config/i386/constraints.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && ((!(
#line 218 "../.././gcc/config/i386/constraints.md"
(TARGET_X32))) && (memory_operand (op, mode)))) || ((
#line 220 "../.././gcc/config/i386/constraints.md"
(TARGET_X32)) && ((
...
satisfies_constraint_BC (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 230 "../.././gcc/config/i386/constraints.md"
(TARGET_SSE)) && ((
...
{
  return (GET_CODE (op) == MEM) && (
#line 250 "../.././gcc/config/i386/constraints.md"
(memory_address_addr_space_p (GET_MODE (op), XEXP (op, 0),
						 MEM_ADDR_SPACE (op))));
}
static inline bool
...
#line 257 "../.././gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 7)));
}
static inline bool
satisfies_constraint_Ww (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 262 "../.././gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 15)));
}
static inline bool
satisfies_constraint_I (rtx op)
...
#line 310 "../.././gcc/config/i386/constraints.md"
...
satisfies_constraint_C (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 315 "../.././gcc/config/i386/constraints.md"
...
satisfies_constraint_We (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (x86_64_immediate_operand (op, mode)) && (
#line 334 "../.././gcc/config/i386/constraints.md"
(mode != VOIDmode));
}
static inline bool
...
#line 341 "../.././gcc/config/i386/constraints.md"
(mode != VOIDmode));
}
static inline bool
