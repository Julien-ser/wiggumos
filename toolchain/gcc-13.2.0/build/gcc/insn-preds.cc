...
#line 106 "../../gcc/config/i386/predicates.md"
(TARGET_64BIT)) && (
#line 107 "../../gcc/config/i386/predicates.md"
(GET_MODE (op) == DImode))) || ((
#line 108 "../../gcc/config/i386/predicates.md"
(GET_MODE (op) == SImode)) || ((
#line 109 "../../gcc/config/i386/predicates.md"
(GET_MODE (op) == HImode)) || (
...
bool
nonimm_x64constmem_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (register_operand (op, mode)) || ((memory_operand (op, mode)) && ((!(
#line 116 "../../gcc/config/i386/predicates.md"
(TARGET_64BIT))) || (
#line 117 "../../gcc/config/i386/predicates.md"
(constant_address_p (XEXP (op, 0))))));
}

bool
general_x64constmem_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (nonmemory_operand (op, mode)) || ((memory_operand (op, mode)) && ((!(
...
{
  return (
#line 129 "../../gcc/config/i386/predicates.md"
...
{
  return ((
#line 137 "../../gcc/config/i386/predicates.md"
(SSE_FLOAT_MODE_P (mode) && TARGET_SSE_MATH)) && (!(
#line 138 "../../gcc/config/i386/predicates.md"
...
{
  return ((
#line 145 "../../gcc/config/i386/predicates.md"
(SSE_FLOAT_MODE_P (mode) && TARGET_SSE_MATH)) && (!(
#line 146 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 152 "../../gcc/config/i386/predicates.md"
...
#line 185 "../../gcc/config/i386/predicates.md"
{
...
#line 408 "../../gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
#line 431 "../../gcc/config/i386/predicates.md"
{
  if (ix86_endbr_immediate_operand (op, VOIDmode))
    return false;
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && ((!(
#line 459 "../../gcc/config/i386/predicates.md"
(TARGET_64BIT))) || ((
#line 460 "../../gcc/config/i386/predicates.md"
(ix86_cmodel == CM_SMALL)) || (
#line 461 "../../gcc/config/i386/predicates.md"
(ix86_cmodel == CM_KERNEL))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 465 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 473 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 482 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 489 "../../gcc/config/i386/predicates.md"
...
#line 499 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 520 "../../gcc/config/i386/predicates.md"
...
#line 530 "../../gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 602 "../../gcc/config/i386/predicates.md"
{
...
#line 637 "../../gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == CONST
      && GET_CODE (XEXP (op, 0)) == PLUS
      && CONST_INT_P (XEXP (XEXP (op, 0), 1)))
...
{
  return ((!(
#line 659 "../../gcc/config/i386/predicates.md"
(TARGET_VXWORKS_RTP))) || ((
#line 660 "../../gcc/config/i386/predicates.md"
(ix86_cmodel == CM_LARGE)) || (
#line 661 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 671 "../../gcc/config/i386/predicates.md"
...
tls_address_pattern (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 675 "../../gcc/config/i386/predicates.md"
...
#line 695 "../../gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 709 "../../gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 728 "../../gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 764 "../../gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
  if (CONSTANT_P (op))
    return true;
...
{
  return (
#line 791 "../../gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((call_register_no_elim_operand (op, mode)) || ((!(
#line 794 "../../gcc/config/i386/predicates.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && (((!(
#line 795 "../../gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))) || ((
#line 797 "../../gcc/config/i386/predicates.md"
...
#line 815 "../../gcc/config/i386/predicates.md"
...
#line 829 "../../gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 838 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 853 "../../gcc/config/i386/predicates.md"
...
#line 859 "../../gcc/config/i386/predicates.md"
{
...
#line 867 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 1 || i == 2 || i == 3;
}
...
#line 891 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
#line 907 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || i == 8;
}
...
(op == const0_rtx)) || (
#line 916 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 921 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 926 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 936 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 941 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 946 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 951 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 956 "../../gcc/config/i386/predicates.md"
...
#line 974 "../../gcc/config/i386/predicates.md"
{
  unsigned HOST_WIDE_INT val = INTVAL (op);
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 989 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 994 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 999 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1004 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1009 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1014 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1024 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1034 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1039 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1044 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1059 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1064 "../../gcc/config/i386/predicates.md"
...
{
  return ((register_operand (op, mode)) && (
#line 1085 "../../gcc/config/i386/predicates.md"
...
{
  return ((register_operand (op, mode)) && ((
#line 1095 "../../gcc/config/i386/predicates.md"
(TARGET_SSE4_1)) && (
#line 1096 "../../gcc/config/i386/predicates.md"
...
#line 1103 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 1104 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx)))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
#line 1111 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 1115 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 1120 "../../gcc/config/i386/predicates.md"
...
#line 1128 "../../gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 1149 "../../gcc/config/i386/predicates.md"
{
  mode = GET_MODE (op);
...
#line 1196 "../../gcc/config/i386/predicates.md"
(INTEGRAL_MODE_P (GET_MODE (op)))) && (
#line 1197 "../../gcc/config/i386/predicates.md"
(op == CONSTM1_RTX (GET_MODE (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 1203 "../../gcc/config/i386/predicates.md"
{
  mode = GET_MODE (op);
...
#line 1228 "../../gcc/config/i386/predicates.md"
{
  mode = GET_MODE (op);
  if (GET_MODE_CLASS (mode) != MODE_VECTOR_INT
      || GET_MODE_SIZE (mode) != 64)
...
(TARGET_AVX)) || (
#line 1253 "../../gcc/config/i386/predicates.md"
...
#line 1269 "../../gcc/config/i386/predicates.md"
(TARGET_AVX512F)) && ((
#line 1270 "../../gcc/config/i386/predicates.md"
(TARGET_AVX512VL)) || (
#line 1271 "../../gcc/config/i386/predicates.md"
(GET_MODE_SIZE (GET_MODE (op)) == 64)))) && ((
#line 1272 "../../gcc/config/i386/predicates.md"
(VALID_BCST_MODE_P (GET_MODE_INNER (GET_MODE (op))))) && ((
#line 1273 "../../gcc/config/i386/predicates.md"
(GET_MODE (XEXP (op, 0))
		    == GET_MODE_INNER (GET_MODE (op)))) && (
#line 1275 "../../gcc/config/i386/predicates.md"
...
{
  return (nonimmediate_operand (op, mode)) || ((
#line 1290 "../../gcc/config/i386/predicates.md"
...
#line 1302 "../../gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
{
  return (nonimmediate_operand (op, mode)) || ((
#line 1320 "../../gcc/config/i386/predicates.md"
...
{
  return (memory_operand (op, mode)) && (!(
#line 1334 "../../gcc/config/i386/predicates.md"
...
#line 1345 "../../gcc/config/i386/predicates.md"
{
...
{
  return (
#line 1344 "../../gcc/config/i386/predicates.md"
...
#line 1363 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
  rtx disp;
...
{
  return ((
#line 1362 "../../gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1407 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1468 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1480 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1537 "../../gcc/config/i386/predicates.md"
...
#line 1558 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1601 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1617 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1637 "../../gcc/config/i386/predicates.md"
...
#line 1682 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1691 "../../gcc/config/i386/predicates.md"
...
#line 1697 "../../gcc/config/i386/predicates.md"
{
...
#line 1728 "../../gcc/config/i386/predicates.md"
{
...
#line 1752 "../../gcc/config/i386/predicates.md"
...
#line 1758 "../../gcc/config/i386/predicates.md"
(XINT (XVECEXP (op, 0, 1), 1) == UNSPEC_CALLEE_ABI)) && (
#line 1759 "../../gcc/config/i386/predicates.md"
...
#line 1764 "../../gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  int swapped;
  HOST_WIDE_INT mask;
...
#line 1800 "../../gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  bool swapped;
  int nunits, elt;
...
#line 1831 "../../gcc/config/i386/predicates.md"
{
...
#line 1863 "../../gcc/config/i386/predicates.md"
{
...
#line 1893 "../../gcc/config/i386/predicates.md"
{
  int perm[128];
...
#line 1923 "../../gcc/config/i386/predicates.md"
{
  int perm[128];
...
#line 1954 "../../gcc/config/i386/predicates.md"
{
  int nelt = XVECLEN (op, 0);
  int elt, i;
...
#line 1984 "../../gcc/config/i386/predicates.md"
{
...
#line 1998 "../../gcc/config/i386/predicates.md"
{
  rtx elt = XVECEXP (op, 0, 0);
  int i, nelt = XVECLEN (op, 0);
...
#line 2014 "../../gcc/config/i386/predicates.md"
{
...
#line 2029 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT val = INTVAL (op);
...
{
  return (register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 2044 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
#line 2050 "../../gcc/config/i386/predicates.md"
{
...
#line 2091 "../../gcc/config/i386/predicates.md"
{
  const unsigned len = XVECLEN (op, 0);
  unsigned i;
...
#line 2130 "../../gcc/config/i386/predicates.md"
{
  unsigned i;
  rtx elt;
...
#line 2174 "../../gcc/config/i386/predicates.md"
{
  unsigned i;
  rtx elt;
...
#line 2225 "../../gcc/config/i386/predicates.md"
{
  unsigned i;
  rtx elt;
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 267 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 31));

    case CONSTRAINT_J:
      return 
#line 272 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 63));

    case CONSTRAINT_K:
      return 
#line 277 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, -128, 127));

    case CONSTRAINT_L:
      return (
#line 283 "../../gcc/config/i386/constraints.md"
(ival == 0xff)) || ((
#line 284 "../../gcc/config/i386/constraints.md"
(ival == 0xffff)) || (
#line 285 "../../gcc/config/i386/constraints.md"
(ival == (HOST_WIDE_INT) 0xffffffff)));

    case CONSTRAINT_M:
      return 
#line 290 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 3));

    case CONSTRAINT_N:
      return 
#line 296 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 255));

    case CONSTRAINT_O:
      return 
#line 301 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 127));
